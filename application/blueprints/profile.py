...
def profile_get() -> str | Response:
    ...
    return render_template("html/user/../templates/html/user/profile.html", user_info=current_user_profile_info())
...
def profile_edit() -> str | Response:
    ...
    return render_template("html/user/../templates/html/user/profile.html", user_info=current_user_profile_info(), edit=True)
