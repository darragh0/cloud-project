...
def events_main() -> str:
    ...
    return render_template(
        "html/student/../templates/html/student/events.html",
...
def events_club_info() -> str:
    ...
    if club_id is not None:
        ...
        if club_information:
            return render_template("html/student/../templates/html/student/club-info.html", club_information=club_information)
