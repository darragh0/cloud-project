...
def cohome():
    ...
    return render_template(
        "html/coordinator/../templates/html/coordinator/coordinator-dashboard.html",
...
def view_members(status):
    ...
    return render_template(
        "html/coordinator/../templates/html/coordinator/member-view.html",
        status=status,
...
def parview(status, event_id):
    ...
    return render_template(
        "html/coordinator/../templates/html/coordinator/view-participants.html",
        status=status,
        event_id=event_id,
...
def see_events(timeline):
    ...
    return render_template(
        "html/coordinator/../templates/html/coordinator/multi-event-view.html",
        timeline=timeline,
...
def new_event():
    ...
    return render_template("html/coordinator/../templates/html/coordinator/single-event-view.html")
...
def edit_event(event_id):
    ...
    return render_template(
        "html/coordinator/../templates/html/coordinator/single-event-view.html",
        event_id=event_id,
